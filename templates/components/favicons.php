...
<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/public/favicons/favicon-196x196.png" sizes="196x196">
<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/public/favicons/favicon-160x160.png" sizes="160x160">
...
<meta name="msapplication-TileImage" content="<?php echo get_template_directory_uri(); ?>/public/favicons/mstile-144x144.png">
